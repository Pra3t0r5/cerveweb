...
then echo "Please run as root"
    exit
        ...
        wget https://trello-attachments.s3.amazonaws.com/5d952a113b1ad84a91fb61a1/5d952f57131cda03c5780e94/a498223933f04636a7e8281d2706d9f3/cerveweb_presentacion.sql
        ...
        mysql -ucerveweb -pbeerjesus cerveweb < cerveweb_presentacion.sql
